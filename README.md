...
The panel also includes a **Save As** button for downloading a detailed Word-compatible `.doc` file. Notes are hidden by default and can be shown with the panel's **Show Notes** button when notes are available.
